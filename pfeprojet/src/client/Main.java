		...
		try {
			...
			*/
			...
			/*
						...
						service.ajouterTechnicien("Dubois","CR7", "10, Villeneuve d'ascq", "0655667788");
			*/
			service.ajouterEntreprise("Euratech", "Lille","d@yahoo.fr","256789", "KEMO");
			service.ajouterEntreprise("TechMa", "Paris","c@yahoo.fr","256789", "DIAKITE");
			service.ajouterBatiment("Euratech", "BatimentA", "28, Lille");
			service.ajouterBatiment("Euratech", "BatimentB", "57, Lille");
			service.ajouterBatiment("TechMa", "BatimentA1", "7,Lille");
			// Ajout Types extincteurs
			...
			//service.ajouterTechnicien("Dupont","Ronaldo", "1,Villeneuve d'ascq","0611223344","gmail@gmail.com");
			//service.ajouterTechnicien("Dubois","CR7", "10, Villeneuve d'ascq", "0655667788","yahoo@yahoo.com");
